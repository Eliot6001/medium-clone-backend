...
import { getArticle, submitArticle, getAllArticles, removeArticle, recoverArticle} from '../controllers/articleController';
...
router.put('/recover/:id',authMiddleware,supabaseAuthClientMiddleware  ,
    recoverArticle
)
